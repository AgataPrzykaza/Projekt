...
{
    Przelew p;
    Osoba o(123,"ala", "ala1", "ala2", "ala4", "ala5", "ala6", "ala7");
    Osoba o1;
   ...
   // stringstream ss("123 ala nowak ala@mail.com ala123 12312312312 ul.Mala 1 ABC1234");
   // ss >> o1;
   // Konto k1(2324411, 34.40, 'I', o1);
   //// cout << k1.GetIdOsoby() << " " << k1.GetImie() << " " << k1.GetNazwisko() << " " << k1.GetMail() << " " << k1.GetHaslo() << " " << k1.GetPesel() << " " << k1.GetAdres() << " " << k1.GetNrDowodu() << endl;
   // cout << o1;
    stringstream ss("789 1231378 12000 I");
    Konto k2;
    ss >> k2;
    //cout << k2;
